...
namespace Tellurian.Trains.Planning.App.Contracts
{
    ...
    public static class DriverDutyExtensions
    {
        ...
        public static string TrainOperatingDay(this DriverDuty me, Train train) => me is null ? "" : me.OperationDays.Flags.IsAllOtherDays(train.OperationDaysFlags) ? "" : train.OperationDaysFlags.OperationDays().ShortName;
